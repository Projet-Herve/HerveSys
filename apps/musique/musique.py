...
def widget_musique():
	...
	listmusiques = list_musique(session)
	for m in listmusiques :
		list_ += "<p href=\"#\" class=\"musique-item\" data-val=\"{m}\">{m}</p>".format(m=m)
	audio_files = tag("div",class_=["vosmusiques","card","white","shadows"],contenu=tag("div", class_=["content"],contenu=list_))
